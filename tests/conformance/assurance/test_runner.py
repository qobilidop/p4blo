...
from tests.conformance.assurance import runner
...
def test_provenance_covers_both_engines_fixtures_and_tools() -> None:
    ...
    for file in [
        ...
        "tests/programs/corpus/tutorial_firewall/test_firewall_bloom_semantics.py",
        "tests/conformance/assurance/runner.py",
