...
`spec/arch/P4bloArch/Externs.lean`), which the [stateful](../stateful/README.md)
...
**They are not BMv2's.** The second oracle (`tests/oracles/bmv2/`) showed that
...
are carried as a known divergence in `tests/oracles/test_oracle_bmv2.py`. P4
