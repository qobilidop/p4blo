...
from tests.programs.corpus.forwarder.test_forwarder_action_semantics import (
    environment as action_environment,
)
from tests.programs.corpus.forwarder.test_forwarder_action_semantics import selected_action
from tests.programs.corpus.forwarder.test_forwarder_semantics import assert_program_identity, freeze
from tests.programs.corpus.forwarder.test_forwarder_tables_semantics import (
    ADDRESSES,
    REF,
    SHAPES,
    call,
...
from tests.programs.corpus.forwarder.test_forwarder_tables_semantics import PROFILES as ROUTES
