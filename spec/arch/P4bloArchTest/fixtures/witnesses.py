...
def _types(program: apb.BlockAssembly) -> None:
...
def _externs(program: apb.BlockAssembly) -> None:
...
def build(name: str, spec: Spec) -> apb.BlockAssembly:
...
def generate() -> dict[str, object]:
    ...
    return {
        ...
        "programs": [json.loads(arch_wire.dump_json(program)) for program in PROGRAMS.values()],
        "cases": cases,
    }
