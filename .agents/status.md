...
| Const-entry priority ruling: the specification's numbering replaces the p4c mapping; the `priority` corpus program, its vectors, the BMv2 classification and the ledger's entry must follow | next, after the bridge merges |
