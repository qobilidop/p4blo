...
Golden programs live under impl/python/tests/printer/golden/<name>.p4; regenerate them
with `P4BLO_UPDATE_GOLDENS=1 uv run pytest impl/python/tests/printer/test_program.py`. When
...
GOLDEN_DIR = Path(__file__).resolve().parents[4] / "impl/python/tests/printer/golden"
CORPUS = Path(__file__).resolve().parents[4] / "tests/programs/corpus"
