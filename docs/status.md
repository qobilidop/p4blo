...
| 2. Semantically complete for real programs | four corpus programs match the oracle packet for packet | forwarder, stacks, stateful, csum16 all pass on P4-SpecTec; acl pending |
